...
### 5️⃣ Unidade 5 - Análise de KPIs e apresentação de resultados
Apresentação com as cinco dimensões-chave do risco de fatalidade em rodovias federais (tipo de pista, causa do acidente, período do dia, condição climática e atropelamento de pedestres), com gráficos gerados a partir da base tratada e um painel-resumo comparando os piores cenários de cada KPI contra a taxa geral de letalidade.
- 📑 Apresentação em `Unidade 5/apresentacao_kpis_prf_2025-v5.pdf`
- 🐍 Notebook em `Unidade 5/PRF_2025_KPIs_Graficos_4.ipynb`
- 📘 Documentação da etapa em `Unidade 5/README.md`
...
├── Unidade 5/         # análise de KPIs e apresentação de resultados
...
### 5️⃣ Unidade 5 - Análise de KPIs
1. Abra `Unidade 5/PRF_2025_KPIs_Graficos_4.ipynb` num ambiente com pandas e matplotlib.
2. Rode todas as células em ordem para gerar os gráficos dos 5 KPIs.
3. Os resultados e as análises consolidadas estão em `Unidade 5/apresentacao_kpis_prf_2025-v5.pdf`.
## 📎 Mais detalhes
...
- KPIs e análise de resultados: `Unidade 5/README.md`
## 👤 Autor
